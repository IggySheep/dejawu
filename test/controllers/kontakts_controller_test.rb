...
class KontaktsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kontakt" do
    assert_difference('Kontakt.count') do
      post kontakts_url, params: { kontakt: { abteilung: @kontakt.abteilung, emai: @kontakt.emai, faxno: @kontakt.faxno, name: @kontakt.name, position: @kontakt.position, telno: @kontakt.telno, vorname: @kontakt.vorname } }
    end
  ...
  test "should update kontakt" do
    patch kontakt_url(@kontakt), params: { kontakt: { abteilung: @kontakt.abteilung, emai: @kontakt.emai, faxno: @kontakt.faxno, name: @kontakt.name, position: @kontakt.position, telno: @kontakt.telno, vorname: @kontakt.vorname } }
